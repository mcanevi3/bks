...
\begin{enumerate}[\bfseries S1.]
    ...
    \begin{equation}
        G(s)=\frac{1}{s^2+4s+3}
    \end{equation}
    olarak verilmiştir. Aşımı $\%16.3$ yapacak P kontrolörü tasarlayınız.
    \item (50p)\,Bir transfer fonksiyonu
    \begin{equation}
        G(s)=\frac{1}{s+0.2}
    \end{equation}
    olarak verilmiştir. Aşımı $\%16.3$ ve yerleşme zamanını $t_s=2\,s$ yapan PI kontrolör tasarlayınız.
\end{enumerate}
